...
def process_song_data(spark, input_data, output_data):
    """
    Transforms the input JSON file into 2 analytics dataframes, and write it the specified output location
    Output location can be specified in dl.cfg file. Ouput can be Local or Remote AWS location 
    
    Parameters:
    -- spark - spark session object
    -- input_data - string specifying which path to read from config file
    -- output_data - string specifying which path to read from config file
    """
...
def process_log_data(spark, input_data, output_data, songs_data):
    ...
    """
    Transforms the input JSON file into 3 analytics dataframes, and write it the specified output location
    Output location can be specified in dl.cfg file. Ouput can be Local or Remote AWS location
...
def main():
    ...
    Specify whether using LOCAL or REMOTE datasets from AWS is used, determines paths from config file
    If we wish to inclide LOCAL dataset, details for the same needs to be updated in dl.cfg file 
    """
